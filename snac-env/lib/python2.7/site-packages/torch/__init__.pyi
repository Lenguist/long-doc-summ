...
def rrelu(self: Tensor, lower: Number=0.125, upper: Number=0.333333333333, training: _bool=False, generator: Generator=None) -> Tensor: ...
def rrelu_(self: Tensor, lower: Number=0.125, upper: Number=0.333333333333, training: _bool=False, generator: Generator=None) -> Tensor: ...

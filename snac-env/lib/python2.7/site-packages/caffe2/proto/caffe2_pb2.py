...
TensorBoundShape = _reflection.GeneratedProtocolMessageType('TensorBoundShape', (_message.Message,), dict(
...
TensorBoundShapes = _reflection.GeneratedProtocolMessageType('TensorBoundShapes', (_message.Message,), dict(
